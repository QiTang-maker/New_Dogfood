...
class ParamBuilder:
    ...
    @Builder.add(Command.READ, Command.WRITE, Command.TAC)
    ...
    def expand_command(self, cmd):
        ...
        elif cmd.type_ in (Command.READ, Command.WRITE, Command.TAC):
        ...
        elif cmd.type_ == Command.SPLIT:
            pass
            #cmd.lines_ = self._build_split_param(cmd)
        else:
            pass
